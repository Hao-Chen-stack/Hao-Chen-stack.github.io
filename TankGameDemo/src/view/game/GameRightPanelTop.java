...
public class GameRightPanelTop extends JPanel{
    public Font font = new Font("宋体",Font.PLAIN,20);
    public JLabel label1 = new JLabel("敌方坦克还有");
    public JLabel imgLabel2 = new JLabel(new ImageIcon("image/tankbaiup.png"));
    ...
    public GameRightPanelTop(){
        ...
        imgLabel2.setBounds(20,40,24,24);
        label2.setBounds(20,40,150,20);
        imgLabel3.setBounds(20,80,25,25);
        label3.setBounds(20,80,150,20);
        imgLabel4.setBounds(20,120,25,25);
        label4.setBounds(20,120,150,20);
        imgLabel5.setBounds(20,160,25,25);
        label5.setBounds(20,160,150,20);
        imgLabel6.setBounds(20,200,25,25);
